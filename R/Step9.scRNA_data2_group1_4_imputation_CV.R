...
method6 = "scGNGI"
file_name6 = "scGNGI_iter1_r4.csv"

# raw_impute_data_with_methods [1.1]
df_method1 <- read.csv(paste0("./scRNA_data2_group1_4/scRNA_data2_group1_4_proprecessing_", method1, "/scRNA_data2_group1_4_proprecessing_",file_name1))
rownames(df_method1) <- df_method1[,1]
df_method1 <- df_method1[,-1]

df_method2 <- read.csv(paste0("./scRNA_data2_group1_4/scRNA_data2_group1_4_proprecessing_", method2, "/scRNA_data2_group1_4_proprecessing_",file_name2))
rownames(df_method2) <- df_method2[,1]
df_method2 <- df_method2[,-1]

df_method3 <- read.csv(paste0("./scRNA_data2_group1_4/scRNA_data2_group1_4_proprecessing_", method3, "/scRNA_data2_group1_4_proprecessing_",file_name3))
rownames(df_method3) <- df_method3[,1]
df_method3 <- df_method3[,-1]

df_method4 <- read.csv(paste0("./scRNA_data2_group1_4/scRNA_data2_group1_4_proprecessing_", method4, "/scRNA_data2_group1_4_proprecessing_",file_name4))
rownames(df_method4) <- df_method4[,1]
df_method4 <- df_method4[,-1]

df_method5 <- read.csv(paste0("./scRNA_data2_group1_4/scRNA_data2_group1_4_proprecessing_", method5, "/scRNA_data2_group1_4_proprecessing_",file_name5))
rownames(df_method5) <- df_method5[,1]
df_method5 <- df_method5[,-1]

df_method6 <- read.csv(paste0("./scRNA_data2_group1_4/scRNA_data2_group1_4_proprecessing_", method6, "/scRNA_data2_group1_4_proprecessing_",file_name6))
rownames(df_method6) <- df_method6[,1]
df_method6 <- df_method6[,-1]

log.scimpute.res<- log2(df_method1+1)
log.saver.res <- log2(df_method2+1)
log.drimpute.res <- log2(df_method3+1)
log.alra.res <- log2(df_method4+1)
log.deepimpute.res <- log2(df_method5+1)
log.scGNGI.res <- log2(df_method6+1)

# save(log.scimpute.res, log.saver.res, log.magic.res, log.drimpute.res,  log.alra.res, log.deepimpute.res, log.scGNGI.res, file = "./scRNA_data2_group1_4/scRNA_data2_group1_4_proprecessing_impute_res_summary")
save(log.scimpute.res, log.saver.res, log.drimpute.res,  log.alra.res, log.deepimpute.res, log.scGNGI.res, file = "./scRNA_data2_group1_4/scRNA_data2_group1_4_proprecessing_impute_res_summary")

#################################################### [1] ####################################################

load("./scRNA_data2_group1_4/scRNA_data2_group1_4_proprecessing_impute_res_summary")
...
for(i in 1:4){
  ...
  ggsave(gg, file = paste0("./results/CV/scRNA_data2_group1_4_proprecessing_",  cell.category[i], "_CV_zero_comparison.eps"), width = 12, height = 7)
