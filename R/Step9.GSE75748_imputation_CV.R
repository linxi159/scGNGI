...
#save(log.scimpute.res, log.saver.res, log.magic.res, log.drimpute.res,  log.alra.res, log.deepimpute.res, log.scGNGI.res, file = "./GSE75748/GSE75748_sc_cell_type_ec_proprecessing_impute_res_summary")
save(log.scimpute.res, log.saver.res, log.drimpute.res,  log.alra.res, log.deepimpute.res, log.scGNGI.res, file = "./GSE75748/GSE75748_sc_cell_type_ec_proprecessing_impute_res_summary")

#################################################### [1] ####################################################

load("./GSE75748/GSE75748_sc_cell_type_ec_proprecessing_impute_res_summary")
...
celltype <- strsplit(colnames(df_raw), "_") # GSE75748
label <- vector()
...
for(i in 1:7){
  ...
  ggsave(gg, file = paste0("./results/CV/GSE75748_sc_cell_type_ec_proprecessing_",  cell.category[i], "_CV_zero_comparison.eps"), width = 12, height = 7)
