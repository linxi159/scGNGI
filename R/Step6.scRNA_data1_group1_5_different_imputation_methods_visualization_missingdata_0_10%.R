...
save(tsne_raw, tsne_raw_missing, tsne_scImpute, tsne_SAVER, tsne_DrImpute, tsne_scGNGI, umap_raw, umap_raw_missing, umap_scImpute, umap_SAVER, umap_DrImpute, umap_scGNGI, file = paste0("./results/visualization/scRNA_data1_group1_5/tsne_umap_results.summary"))

#################################################### [7] ####################################################
setwd("~/r_workplace/8.genes_imputation/data")
load(paste0("./results/visualization/scRNA_data1_group1_5/tsne_umap_results.summary"))
...
plot(tsne_scImpute,col=colors[df$label],pch=16,
     xlab = "t-SNE1",ylab = "t-SNE2",main = method_scImpute,cex.axis=0.8,cex.lab=0.8,cex.main=0.8)
# 添加分隔线
abline(h=0,v=0,lty=2,col="gray")
...
plot(umap_scImpute,col=colors[df$label],pch=16,
     xlab = "UMAP_1",ylab = "UMAP_2",main = method_scImpute,cex.axis=0.8,cex.lab=0.8,cex.main=0.8)
# 添加分隔线
abline(h=0,v=0,lty=2,col="gray")
