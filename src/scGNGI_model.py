...
def scGNGI(X, omega, rank, verbose=True, alpha=1, max_outer_iter=100,
    ...
    X_hat = U @ V.T
    X_hat_best_2r = X_hat  # stores best intermediate 
    ...
    while iter_num < max_outer_iter and not early_stopping_flag:
        ...
        # report
        if verbose:
          print("[INSIDE scGNGI] iter: " + str(iter_num) + ", relRes: " + str(relRes))
        ...
        if verbose and early_stopping_flag:
          print("[INSIDE scGNGI] early stopping")
