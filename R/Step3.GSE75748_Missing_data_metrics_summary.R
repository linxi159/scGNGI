...
# 1. GSE75748_sc_cell_type_ec_proprecessing.csv 原始的预处理数据
df0 <- read.csv("./GSE75748/GSE75748_sc_cell_type_ec_proprecessing.csv")
rownames(df0) <- df0[,1]
df0 <- df0[,-1]

# 2. GSE75748_sc_cell_type_ec_proprecessing_missingi_mask.csv 掩码位置
df0_missing10.mask <- read.csv(paste0("./GSE75748/GSE75748_sc_cell_type_ec_proprecessing_missing",i,"_mask.csv"))
rownames(df0_missing10.mask) <- df0_missing10.mask[,1]
df0_missing10.mask <- df0_missing10.mask[,-1]

# 3. GSE75748_sc_cell_type_ec_proprecessing_missingi_methods/...csv 填充后数据
df0_missing10.scimpute_imputed <- read.csv(paste0("./GSE75748/GSE75748_sc_cell_type_ec_proprecessing_missing",i,"_scImpute/GSE75748_sc_cell_type_ec_proprecessing_missing",i,"_scImputescimpute_count.csv"))
df0_missing10.saver_imputed <- read.csv(paste0("./GSE75748/GSE75748_sc_cell_type_ec_proprecessing_missing",i,"_SAVER/GSE75748_sc_cell_type_ec_proprecessing_missing",i,"_SAVER_estimate.csv"))
df0_missing10.magic_imputed <- read.csv(paste0("./GSE75748/GSE75748_sc_cell_type_ec_proprecessing_missing",i,"_MAGIC/GSE75748_sc_cell_type_ec_proprecessing_missing",i,"_MAGIC.csv"))
df0_missing10.drimpute_imputed <- read.csv(paste0("./GSE75748/GSE75748_sc_cell_type_ec_proprecessing_missing",i,"_DrImpute/GSE75748_sc_cell_type_ec_proprecessing_missing",i,"_DrImpute.csv"))
df0_missing10.alra_imputed <- read.csv(paste0("./GSE75748/GSE75748_sc_cell_type_ec_proprecessing_missing",i,"_ALRA/GSE75748_sc_cell_type_ec_proprecessing_missing",i,"_ALRA.csv"))
df0_missing10.deepimpute_imputed <- read.csv(paste0("./GSE75748/GSE75748_sc_cell_type_ec_proprecessing_missing",i,"_DeepImpute/GSE75748_sc_cell_type_ec_proprecessing_missing",i,"_DeepImpute.csv"))
df0_missing10.scGNGI_imputed <- read.csv(paste0("./GSE75748/GSE75748_sc_cell_type_ec_proprecessing_missing",i,"_scGNGI/GSE75748_sc_cell_type_ec_proprecessing_missing",i,"_scGNGI_iter1_r7.csv"))
...
# save
save(topredict, scimpute.pred, saver.pred, magic.pred, drimpute.pred, alra.pred, deepimpute.pred, scGNGI.pred, file = paste0("./GSE75748/results_missing",i,"/GSE75748_sc_cell_type_ec_proprecessing_missing",i,"_imputation_log2.summary"))

#### evaluate ####
setwd("~/r_workplace/8.genes_imputation/data")
# absolute.loss
all.res <- NULL
load(paste0("./GSE75748/results_missing",i,"/GSE75748_sc_cell_type_ec_proprecessing_missing",i,"_imputation_log2.summary"))
...
absolute.loss.mean.summary <- data.frame(dataset = rep("Cell Type", nrow(all.res)), 
...
square.loss.mean.summary <- data.frame(dataset = rep("Cell Type", nrow(all.res)), 
                                       scenario = rep(paste0("missing,",i), nrow(all.res)),
                                       scimpute = all.res[, 1],
                                       saver = all.res[, 2],
                                       magic = all.res[, 3],
...
correlation.mean.summary <- data.frame(dataset = rep("Cell Type", nrow(all.res)), 
                                       scenario = rep(paste0("missing,",i), nrow(all.res)),
                                       scimpute = all.res[, 1],
                                       saver = all.res[, 2],
                                       magic = all.res[, 3],
...
f.loss.mean.summary <- data.frame(dataset = rep("Cell Type", nrow(all.res)), 
                                  scenario = rep(paste0("missing,",i), nrow(all.res)),
                                  scimpute = all.res[, 1],
                                  saver = all.res[, 2],
                                  magic = all.res[, 3],
...
# save
save(f.loss.mean.summary, correlation.mean.summary, square.loss.mean.summary, absolute.loss.mean.summary, file = paste0("./GSE75748/results_missing",i,"/GSE75748_sc_cell_type_ec_proprecessing_missing",i,"_evaluate_log2.summary"))
