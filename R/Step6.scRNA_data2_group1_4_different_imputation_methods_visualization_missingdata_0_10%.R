...
save(tsne_raw, tsne_raw_missing, tsne_scImpute, tsne_SAVER, tsne_DrImpute, tsne_scGNGI, umap_raw, umap_raw_missing, umap_scImpute, umap_SAVER, umap_DrImpute, umap_scGNGI, file = paste0("./results/visualization/scRNA_data2_group1_4/tsne_umap_results.summary"))
